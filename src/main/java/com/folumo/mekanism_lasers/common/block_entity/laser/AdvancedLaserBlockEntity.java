...
public class AdvancedLaserBlockEntity extends TileEntityBasicLaser implements ILaserReceptor {
    ...
    protected FloatingLong toFire(){
        return FloatingLong.createConst(20000L);
    }

    @Override
    public @NotNull Component getName() {
        return Component.literal("Advanced Laser");
    }
